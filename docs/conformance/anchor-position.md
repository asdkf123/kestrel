...
| 영역 | 통과 / 전체 | % | 비고 |
|---|---|---|---|
| **CSS WPT 전량** | 64,219 / 125,685 | **51.1%** | 세션 시작 baseline(파일 6,860) |
| **css-anchor-position** | 7,425 / 13,001 | **57.1%** | 이번 세션 후(파일 247) |
...
| position-area-parsing | 325 / 2,125 | 15.3% | 미착수 |
| position-area-computed | 0 / 633 | 0.0% | 미착수 |
...
1. **position-area** (parsing 15.3% + computed 0%) — 2D 축 호환성 그리드 문법. 직렬화가
   풀렸으니 이제 착수 가능(다음 대상).
