...
if (!window.Iterator) {
  ...
  __kIterProto.map = function(fn){ 'use strict'; __kIterRecv(this); __kIterFn(fn); var it=this,nx=it.next,i=0; return __kIterHelper(it, function(){ return (function*(){ while(true){ var r=__kIterStep(nx,it); if(r.done) return; var m; try{ m=fn(r.value,i++); }catch(e){ __kIterClose(it); throw e; } yield m; } })(); }); };
  __kIterProto.filter = function(fn){ 'use strict'; __kIterRecv(this); __kIterFn(fn); var it=this,nx=it.next,i=0; return __kIterHelper(it, function(){ return (function*(){ while(true){ var r=__kIterStep(nx,it); if(r.done) return; var k; try{ k=fn(r.value,i++); }catch(e){ __kIterClose(it); throw e; } if(k) yield r.value; } })(); }); };
  __kIterProto.take = function(n){ 'use strict'; __kIterRecv(this); var lim=Math.trunc(+n); if(!(lim>=0)) throw new RangeError('take limit must be a non-negative number'); var it=this,nx=it.next; return __kIterHelper(it, function(){ return (function*(){ var c=0; if(c>=lim){ __kIterClose(it); return; } while(true){ var r=__kIterStep(nx,it); if(r.done) return; yield r.value; c++; if(c>=lim){ __kIterClose(it); return; } } })(); }); };
  __kIterProto.drop = function(n){ 'use strict'; __kIterRecv(this); var lim=Math.trunc(+n); if(!(lim>=0)) throw new RangeError('drop limit must be a non-negative number'); var it=this,nx=it.next; return __kIterHelper(it, function(){ return (function*(){ var c=0; while(c<lim){ var r=__kIterStep(nx,it); if(r.done) return; c++; } while(true){ var r2=__kIterStep(nx,it); if(r2.done) return; yield r2.value; } })(); }); };
  __kIterProto.flatMap = function(fn){ 'use strict'; __kIterRecv(this); __kIterFn(fn); var it=this,nx=it.next,i=0; return __kIterHelper(it, function(){ return (function*(){ while(true){ var r=__kIterStep(nx,it); if(r.done) return; var inner; try{ inner=fn(r.value,i++); }catch(e){ __kIterClose(it); throw e; } var iit=(inner!=null && inner[Symbol.iterator])?inner[Symbol.iterator]():inner; while(true){ var ir=iit.next(); if(ir.done) break; yield ir.value; } } })(); }); };
  __kIterProto.reduce = function(fn){ 'use strict'; __kIterRecv(this); __kIterFn(fn); var it=this,nx=it.next,i=0,acc,has=arguments.length>1; if(has) acc=arguments[1]; while(true){ var r=__kIterStep(nx,it); if(r.done) break; if(!has){ acc=r.value; has=true; continue; } acc=fn(acc,r.value,i); i++; } if(!has) throw new TypeError('Reduce of empty iterator with no initial value'); return acc; };
  ...
  __kIterProto.forEach = function(fn){ 'use strict'; __kIterRecv(this); __kIterFn(fn); var it=this,nx=it.next,i=0; while(true){ var r=__kIterStep(nx,it); if(r.done) break; fn(r.value,i++); } return undefined; };
  __kIterProto.some = function(fn){ 'use strict'; __kIterRecv(this); __kIterFn(fn); var it=this,nx=it.next,i=0; while(true){ var r=__kIterStep(nx,it); if(r.done) return false; var m; try{ m=fn(r.value,i++); }catch(e){ __kIterClose(it); throw e; } if(m){ __kIterClose(it); return true; } } };
  __kIterProto.every = function(fn){ 'use strict'; __kIterRecv(this); __kIterFn(fn); var it=this,nx=it.next,i=0; while(true){ var r=__kIterStep(nx,it); if(r.done) return true; var m; try{ m=fn(r.value,i++); }catch(e){ __kIterClose(it); throw e; } if(!m){ __kIterClose(it); return false; } } };
  __kIterProto.find = function(fn){ 'use strict'; __kIterRecv(this); __kIterFn(fn); var it=this,nx=it.next,i=0; while(true){ var r=__kIterStep(nx,it); if(r.done) return undefined; var m; try{ m=fn(r.value,i++); }catch(e){ __kIterClose(it); throw e; } if(m){ __kIterClose(it); return r.value; } } };
