...
pub fn initial_value(prop: &str) -> Option<&'static str> {
    Some(match prop {
        ...
        // UI/인터랙션/표 키워드 프로퍼티 초기값
        "cursor" | "user-select" | "pointer-events" | "touch-action" | "image-rendering"
        | "isolation" | "overflow-anchor" | "scroll-behavior" | "text-underline-position"
        | "will-change" | "text-align-last" => "auto",
        "appearance" | "resize" | "contain" => "none",
        "hyphens" => "manual",
        "hyphenate-limit-chars" | "hyphenate-character" => "auto",
        ...
        "overscroll-behavior-x" | "overscroll-behavior-y" => "auto",
        ...
        // 3차 배치 초기값
        "grid-auto-flow" => "row",
        "grid-auto-columns" | "text-underline-offset" | "column-width" | "caret-shape" => "auto",
        "break-before" | "break-after" | "break-inside" | "page-break-before"
        | "page-break-after" | "page-break-inside" => "auto",
        "column-span" | "counter-reset" | "counter-increment" | "counter-set" => "none",
        "column-fill" => "balance",
        ...
        "stroke-dasharray" | "vector-effect" | "marker-start" | "marker-mid"
        | "marker-end" => "none",
        "stroke-dashoffset" | "baseline-shift" => "0px",
        "stroke-miterlimit" => "4",
        "clip-rule" | "fill-rule" => "nonzero",
        "paint-order" => "normal",
        "dominant-baseline" | "shape-rendering" => "auto",
        "text-anchor" => "start",
        ...
        // position-area 초기값(§css-anchor-2): none.
        "position-area" => "none",
        ...
        "overscroll-behavior-block" | "overscroll-behavior-inline" => "auto",
